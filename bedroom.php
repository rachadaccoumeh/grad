...
<script src="wishlist.js"></script>
  ...
  <div class="carousel-container">
    <div class="carousel">
      <div class="carousel-image"><img src="brphoto/IMG_5882.JPG" alt="Bedroom Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5883.JPG" alt="Bedroom Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5884.JPG" alt="Bedroom Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5885.JPG" alt="Bedroom Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5886.JPG" alt="Bedroom Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5889.JPG" alt="Bedroom Interior"></div>
    </div>
  ...
  <section class="products">
    <div class="product-grid" id="productGrid">
      <div class="product-card" data-style="Modern" data-price="7500" data-size="Medium" data-date="2025-01-15" data-id="B2">
        <div class="gallery-image">
          <img src="brphoto/Br1.JPG" alt="Modern Bedroom Set">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Contemporary Platform Bed Set</h4>
          </div>
          <div class="gallery-description">Sleek modern bedroom set featuring a low-profile platform bed with integrated nightstands, soft LED lighting, and minimalist dresser with matte finish.</div>
      ...
      <div class="product-card" data-style="Rustic" data-price="4880" data-size="Medium" data-date="2024-12-10" data-id="B3">
        <div class="gallery-image">
          <img src="brphoto/Br2.JPG" alt="Rustic Bedroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Farmhouse Oak Bedroom Collection</h4>
          </div>
          <div class="gallery-description">Rustic bedroom set with reclaimed oak four-poster bed, matching bedside tables, and a spacious 6-drawer dresser with antique bronze hardware.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Minimalist" data-price="3900" data-size="Small" data-date="2025-01-05" data-id="B5">
        ...
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Essential Bedroom Package</h4>
          </div>
          <div class="gallery-description">Minimalist bedroom set with floating bed frame, wall-mounted nightstands, and a compact dresser in white and natural wood tones with hidden handles.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Traditional" data-price="6200" data-size="Medium" data-date="2024-11-15" data-id="B6">
        <div class="gallery-image">
          <img src="brphoto/Br5.JPG" alt="Traditional Bedroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Classic Cherry Bedroom Set</h4>
          </div>
          <div class="gallery-description">Traditional bedroom suite featuring a solid cherry sleigh bed, matching nightstands with ornate details, and an elegant 8-drawer dresser with beveled mirror.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Modern" data-price="8700" data-size="Large" data-date="2025-02-10" data-id="B7">
        <div class="gallery-image">
          <img src="brphoto/Br6.JPG" alt="Modern Luxury Bedroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Premium Suite Collection</h4>
          </div>
          <div class="gallery-description">Luxury modern bedroom set with king-size upholstered bed frame in gray velvet, marble-top nightstands, and a designer chest of drawers with gold accents.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Minimalist" data-price="4300" data-size="Medium" data-date="2025-03-01" data-id="B8">
        <div class="gallery-image">
          <img src="brphoto/Br7.JPG" alt="Japanese Inspired Bedroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Zen Bedroom Collection</h4>
          </div>
          <div class="gallery-description">Japanese-inspired minimalist bedroom with low platform bed, tatami-style mats, bamboo accents, and modular storage units in natural wood finishes.</div>
          <div class="gallery-meta">
    ...
    <div class="pagination">
      ...
      <button onclick="window.location.href='bedroom2.php'">2</button>
      <button onclick="window.location.href='bedroom2.php'">»</button>
    </div>
  </section>
