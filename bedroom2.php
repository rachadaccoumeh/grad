...
<script src="wishlist.js"></script>
  ...
  <div class="carousel-container">
    <div class="carousel">
      <div class="carousel-image"><img src="brphoto/IMG_5882.JPG" alt="LR Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5883.JPG" alt="LR Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5884.JPG" alt="LR Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5885.JPG" alt="LR Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5886.JPG" alt="LR Interior"></div>
      <div class="carousel-image"><img src="brphoto/IMG_5889.JPG" alt="LR Interior"></div>
    </div>
    <div class="carousel-overlay">
      <h1>Bedroom Category</h1>
      <div class="breadcrumb">
        <a href="home.php"><i class='bx bx-home'></i>Home</a><a href="gallery.php">/ Gallery </a> / Bedroom
      </div>
      <h4 class="carousel-subtext">Discover the perfect blend of comfort and elegance — our bedroom collection transforms your space into a serene retreat with stylish, handpicked pieces designed for rest and beauty.</h4>
    </div>
  </div>

  <section class="categories">
    <div class="section-title">
      <h2>Bedroom products</h2>
      <div class="dropdown">
  ...
  <section class="products">
    <div class="product-grid" id="productGrid">
      <div class="product-card" data-style="Modern" data-price="8500" data-size="Medium" data-date="2025-03-15" data-id="B9" >
        <div class="gallery-image">
          <img src="brphoto/Br8.JPG" alt="Modern Platform Bed Set">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Modern Platform Bed Set</h4>
          </div>
          <div class="gallery-description">Contemporary bedroom set with floating platform bed, built-in nightstands, and recessed LED lighting for a sleek, minimalist aesthetic.</div>
      ...
      <div class="product-card" data-style="Traditional" data-price="12500" data-size="Large" data-date="2025-02-10" data-id="B10">
        <div class="gallery-image">
          <img src="brphoto/Br9.JPG" alt="Luxury King Suite">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Luxury King Bedroom Suite</h4>
          </div>
          <div class="gallery-description">Elegant king bedroom set with carved wooden headboard, matching nightstands, dresser with mirror, and plush upholstered bench in rich walnut finish.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Minimalist" data-price="4200" data-size="Medium" data-date="2025-04-05" data-id="B11">
        <div class="gallery-image">
          <img src="brphoto/Br10.JPG" alt="Scandinavian Bedroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Scandinavian Simplicity Set</h4>
          </div>
          <div class="gallery-description">Clean-lined oak bedroom set with low-profile bed frame, simple nightstands, and compact six-drawer dresser in light natural wood finish.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Industrial" data-price="6800" data-size="Medium" data-date="2025-01-20" data-id="B12">
        <div class="gallery-image">
          <img src="brphoto/Br11.JPG" alt="Industrial Loft Bedroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Industrial Loft Collection</h4>
          </div>
          <div class="gallery-description">Urban-inspired bedroom featuring metal pipe frame queen bed, reclaimed wood nightstands, and matching wardrobe with distressed finish and black metal accents.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Rustic" data-price="9300" data-size="Large" data-date="2025-02-28" data-id="B13">
        <div class="gallery-image">
          <img src="brphoto/Br12.JPG" alt="Farmhouse Bedroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Rustic Farmhouse Suite</h4>
          </div>
          <div class="gallery-description">Charming bedroom set with panel bed featuring shiplap details, barn door-inspired nightstands, and spacious dresser in vintage whitewash and natural wood tones.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Modern" data-price="7500" data-size="Small" data-date="2025-03-10" data-id="B14">
        <div class="gallery-image">
          <img src="brphoto/Br13.JPG" alt="Murphy Wall Bed">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Space-Saving Murphy Bed System</h4>
          </div>
          <div class="gallery-description">Innovative queen wall bed with integrated shelving, fold-down desk, and built-in LED lighting - perfect for guest rooms or small urban apartments.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Traditional" data-price="15800" data-size="Large" data-date="2025-01-05" data-id="B15">
        <div class="gallery-image">
          <img src="brphoto/Br14.JPG" alt="Four-Poster Canopy Bed">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Majestic Four-Poster Set</h4>
          </div>
          <div class="gallery-description">Grand bedroom collection featuring a mahogany four-poster king bed with optional canopy draping, ornate carved nightstands, and stately armoire with antique brass hardware.</div>
          <div class="gallery-meta">
    ...
    <div class="pagination">
      <button onclick="window.location.href='bedroom.php'">«</button>
      <button onclick="window.location.href='bedroom.php'" >1</button>
      <button class="active"onclick="window.location.href='bedroom2.php'">2</button>
      <button onclick="window.location.href='bedroom.php'">»</button>
    </div>
  </section>
