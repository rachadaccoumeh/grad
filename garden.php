...
<head>
  ...
  <title>RoomGenuis Garden Furniture Gallery</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<script src="wishlist.js"></script>
  ...
  <div class="carousel-container">
    <div class="carousel">
      <div class="carousel-image"><img src="garden/IMG_6085.JPG" alt="Garden Furniture 1"></div>
      <div class="carousel-image"><img src="garden/IMG_6086.JPG" alt="Garden Furniture 2"></div>
      <div class="carousel-image"><img src="garden/IMG_6088.JPG" alt="Garden Furniture 3"></div>
      <div class="carousel-image"><img src="garden/IMG_6089.JPG" alt="Garden Furniture 4"></div>
      <div class="carousel-image"><img src="garden/IMG_6090.JPG" alt="Garden Furniture 5"></div>
      <div class="carousel-image"><img src="garden/IMG_6091.JPG" alt="Garden Furniture 6"></div>
    </div>
    <div class="carousel-overlay">
      <h1>Garden Furniture</h1>
      <div class="breadcrumb">
        <a href="home.php"><i class='bx bx-home'></i>Home</a><a href="gallery.php">/ Gallery </a> / Garden
      </div>
      <h4 class="carousel-subtext">Transform your outdoor space into a relaxing retreat with our curated collection of garden furniture.</h4>
    </div>
  </div>

  <section class="categories">
    <div class="section-title">
      <h2>Garden Furniture Collection</h2>
      <div class="dropdown">
        <select class="view-all-btn" name="style" id="style" onchange="filterProducts()">
          ...
          <option class="options" value="Bohemian">Bohemian</option>
        </select>
        ...
        <select class="view-all-btn" name="size" id="size" onchange="filterProducts()">
          ...
          <option value="Small">Weather Resistant</option>
          <option value="Medium">Foldable/Portable</option>
          <option value="Large">Built-in Storage</option>
        </select>
