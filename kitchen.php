...
$page_title = "Kitchen Collection";
$category_description = "Transform your kitchen with our collection of modern appliances, stylish cabinets, and functional accessories for the heart of your home.";
  ...
  <section class="categories">
    <div class="section-title">
      ...
      <div class="dropdown">
        ...
        <button id="clearFilters" class="view-all-btn" style="background-color: #800020; display: none;" onclick="clearAllFilters()">
          back
        </button>
      </div>
    </div>
