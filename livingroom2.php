...
<script src="wishlist.js"></script>
  ...
  <section class="products">
    <div class="product-grid" id="productGrid">
      <div class="product-card" data-style="Modern" data-price="8000" data-size="Medium" data-date="2025-01-15" data-id="L9">
        <div class="gallery-image">
          <img src="lrphoto/Modern2.JPG" alt="Modern lr">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>white and yellow LR </h4>
          </div>
          <div class="gallery-description">white Modern living room with a wooden decorationswith large sofa with a under TV table and a small table in the middle of the room </div>
      ...
      <div class="product-card" data-style="Modern" data-price="4000" data-size="Small" data-date="2024-12-10" data-id="L10">
        <div class="gallery-image">
          <img src="lrphoto/Modern5.JPG" alt="Modern lr">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Modern beige/green LR</h4>
          </div>
          <div class="gallery-description">Medium modern sofa beige with a light green and brown armrest and with a light green carpet and plants decoration with 4 paintings</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Modern" data-price="6000" data-size="Medium" data-date="2025-02-20" data-id="L11">
        <div class="gallery-image">
          <img src="lrphoto/Modern6.JPG" alt="modern lr">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Modern yellow living room</h4>
          </div>
          <div class="gallery-description">Modern yellow living room with a large sofa and armrest beige and green and plants and a white windows with 3 wooden shelfs.</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Rustic" data-price="4500" data-size="Medium" data-date="2025-01-05" data-id="L12">
        <div class="gallery-image">
          <img src="lrphoto/Rustic1.AVIF" alt="Rustic lr">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Rustic living room</h4>
          </div>
          <div class="gallery-description">midium rustic living room with a brown leather long sofa and two sofa chair white and with a rustic wall stone and a room ceiling with wooden decoration</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Rustic" data-price="8500" data-size="Large" data-date="2024-11-15" data-id="L13">
        <div class="gallery-image">
          <img src="lrphoto/Rustic2.WEBP" alt="Rustic  LR">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Large rustic livingroom</h4>
          </div>
          <div class="gallery-description">Large rustic living room with two large sofas brown and a two sofa chair white with colorful armrest and a wooden decoration and a chandelier in the middle of the room ceiling</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Traditional" data-price="5500" data-size="Medium" data-date="2025-03-01" data-id="L14">
        <div class="gallery-image">
          <img src="lrphoto/Traditional1.JPG" alt="traditional livingroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Traditional beige LR</h4>
          </div>
          <div class="gallery-description">traditional living room with long beige sofa and armrest colorful with traditional armrest pattern and also the painting with a long floor lamp</div>
          <div class="gallery-meta">
      ...
      <div class="product-card" data-style="Traditional" data-price="6000" data-size="Medium" data-date="2025-03-01" data-id="L15">
        <div class="gallery-image">
          <img src="lrphoto/Traditional3.JPG" alt="Modern blue livingroom">
        </div>
        <div class="gallery-info">
          <div class="gallery-title">
            <h4>Traditional living room</h4>
          </div>
          <div class="gallery-description">Traditional medium living room with a light gray sofas (one large sofas and two sofa chair ) ansd a colorful armrest and a big wooden table and some other decoration </div>
          <div class="gallery-meta">
            <div class="price">$6,000</div>
            <div class="action-buttons">
              <button class="favorite-btn">♡</button>
    ...
    <div class="pagination">
      ...
      <button class="active"onclick="window.location.href='livingroom2.php'">2</button>
      <button onclick="window.location.href='livingroom3.php'">3</button>
      <button onclick="window.location.href='livingroom3.php'">»</button>
    </div>
  </section>
